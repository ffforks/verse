...
#define V_ENCRYPTION_LOGIN_KEY_FULL_SIZE 512 * 3
#define V_ENCRYPTION_LOGIN_KEY_HALF_SIZE 512 * 2

#define V_ENCRYPTION_LOGIN_PUBLIC_START 512 * 0
#define V_ENCRYPTION_LOGIN_N_START 512 * 1
#define V_ENCRYPTION_LOGIN_PRIVATE_START 512 * 2
