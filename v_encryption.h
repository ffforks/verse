...
#define V_ENCRYPTION_LOGIN_N_START	 (1 * V_ENCRYPTION_LOGIN_KEY_SIZE)
#define V_ENCRYPTION_LOGIN_PRIVATE_START (2 * V_ENCRYPTION_LOGIN_KEY_SIZE)
...
extern void v_e_data_create_key(uint8 *to);
extern void v_e_data_encrypt_command(uint8 *packet, size_t packet_length,
				     const uint8 *command, size_t command_length, uint8 *key);
