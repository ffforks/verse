...
extern unsigned int v_unpack_g_vertex_set_real64_xyz(const char *data, size_t length);
extern unsigned int v_unpack_g_vertex_set_uinteger32(const char *data, size_t length);
extern unsigned int v_unpack_g_vertex_set_real64(const char *data, size_t length);
extern unsigned int v_unpack_g_polygon_set_corner_uinteger32(const char *data, size_t length);
extern unsigned int v_unpack_g_polygon_set_corner_real64(const char *data, size_t length);
extern unsigned int v_unpack_g_polygon_set_face_uinteger8(const char *data, size_t length);
extern unsigned int v_unpack_g_polygon_set_face_uinteger32(const char *data, size_t length);
...
extern unsigned int v_unpack_b_init_dimensions(const char *data, size_t length);
...
extern unsigned int v_unpack_b_layer_set_tile(const char *data, size_t length);
...
extern unsigned int v_unpack_t_line_insert(const char *data, size_t length);
