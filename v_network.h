...
extern int		v_n_send_data(VNetworkAddress *address, const void *data, size_t length);
extern int		v_n_receive_data(VNetworkAddress *address, void *data, size_t length);
