...
void verse_send_g_layer_create(VNodeID node_id, VLayerID layer_id, const char *name, VNGLayerType type, uint32 def_integer, real64 def_real)
{
	...
	printf("send: verse_send_g_layer_create(node_id = %u layer_id = %u name = %s type = %u def_integer = %u def_real = %f );\n", node_id, layer_id, name, type, def_integer, def_real);
	#endif
...
unsigned int v_unpack_g_layer_create(char *buf, unsigned int buffer_length, void *user_func, void *user_data)
{
	...
	printf("receive: verse_send_g_layer_create(node_id = %u layer_id = %u name = %s type = %u def_integer = %u def_real = %f ); callback = %p\n", node_id, layer_id, name, type, def_integer, def_real, user_func);
	#endif
	if(name[0] == 0)
	{
...
void verse_send_g_vertex_set_uinteger32(VNodeID node_id, VLayerID layer_id, uint32 vertex_id, uint32 value)
{
	...
	#if defined(V_PRINT_SEND_COMMANDS)
	printf("send: verse_send_g_vertex_set_uinteger32(node_id = %u layer_id = %u vertex_id = %u value = %u );\n", node_id, layer_id, vertex_id, value);
	#endif
	buffer_pos += vnp_raw_pack_uint32(&buf[buffer_pos], node_id);
	buffer_pos += vnp_raw_pack_uint16(&buf[buffer_pos], layer_id);
	buffer_pos += vnp_raw_pack_uint32(&buf[buffer_pos], vertex_id);
...
unsigned int v_unpack_g_vertex_set_uinteger32(char *buf, unsigned int buffer_length, void *user_func, void *user_data)
{
	...
	#if defined(V_PRINT_RECIVE_COMMANDS)
	printf("receive: verse_send_g_vertex_set_uinteger32(node_id = %u layer_id = %u vertex_id = %u value = %u ); callback = %p\n", node_id, layer_id, vertex_id, value, user_func);
	#endif
...
void verse_send_g_polygon_set_corner_uinteger32(VNodeID node_id, VLayerID layer_id, uint32 polygon_id, uint32 v0, uint32 v1, uint32 v2, uint32 v3)
{
	...
	#if defined(V_PRINT_SEND_COMMANDS)
	printf("send: verse_send_g_polygon_set_corner_uinteger32(node_id = %u layer_id = %u polygon_id = %u v0 = %u v1 = %u v2 = %u v3 = %u );\n", node_id, layer_id, polygon_id, v0, v1, v2, v3);
	#endif
	buffer_pos += vnp_raw_pack_uint32(&buf[buffer_pos], node_id);
	buffer_pos += vnp_raw_pack_uint16(&buf[buffer_pos], layer_id);
...
unsigned int v_unpack_g_polygon_set_corner_uinteger32(char *buf, unsigned int buffer_length, void *user_func, void *user_data)
{
	...
	#if defined(V_PRINT_RECIVE_COMMANDS)
	printf("receive: verse_send_g_polygon_set_corner_uinteger32(node_id = %u layer_id = %u polygon_id = %u v0 = %u v1 = %u v2 = %u v3 = %u ); callback = %p\n", node_id, layer_id, polygon_id, v0, v1, v2, v3, user_func);
	#endif
	if(v0 == -1 || v1 == -1 || v2 == -1)
	{
...
void verse_send_g_polygon_set_face_uinteger8(VNodeID node_id, VLayerID layer_id, uint32 polygon_id, uint8 value)
{
	...
	#if defined(V_PRINT_SEND_COMMANDS)
	printf("send: verse_send_g_polygon_set_face_uinteger8(node_id = %u layer_id = %u polygon_id = %u value = %u );\n", node_id, layer_id, polygon_id, value);
	#endif
	buffer_pos += vnp_raw_pack_uint32(&buf[buffer_pos], node_id);
	buffer_pos += vnp_raw_pack_uint16(&buf[buffer_pos], layer_id);
	buffer_pos += vnp_raw_pack_uint32(&buf[buffer_pos], polygon_id);
...
unsigned int v_unpack_g_polygon_set_face_uinteger8(char *buf, unsigned int buffer_length, void *user_func, void *user_data)
{
	...
	#if defined(V_PRINT_RECIVE_COMMANDS)
	printf("receive: verse_send_g_polygon_set_face_uinteger8(node_id = %u layer_id = %u polygon_id = %u value = %u ); callback = %p\n", node_id, layer_id, polygon_id, value, user_func);
	#endif
...
void verse_send_g_polygon_set_face_uinteger32(VNodeID node_id, VLayerID layer_id, uint32 polygon_id, uint32 value)
{
	...
	#if defined(V_PRINT_SEND_COMMANDS)
	printf("send: verse_send_g_polygon_set_face_uinteger32(node_id = %u layer_id = %u polygon_id = %u value = %u );\n", node_id, layer_id, polygon_id, value);
	#endif
	buffer_pos += vnp_raw_pack_uint32(&buf[buffer_pos], node_id);
	buffer_pos += vnp_raw_pack_uint16(&buf[buffer_pos], layer_id);
	buffer_pos += vnp_raw_pack_uint32(&buf[buffer_pos], polygon_id);
...
unsigned int v_unpack_g_polygon_set_face_uinteger32(char *buf, unsigned int buffer_length, void *user_func, void *user_data)
{
	...
	buffer_pos += vnp_raw_unpack_uint32(&buf[buffer_pos], &value);
	#if defined(V_PRINT_RECIVE_COMMANDS)
	printf("receive: verse_send_g_polygon_set_face_uinteger32(node_id = %u layer_id = %u polygon_id = %u value = %u ); callback = %p\n", node_id, layer_id, polygon_id, value, user_func);
	#endif
...
void verse_send_g_bone_create(VNodeID node_id, uint32 bone_id, const char *name, uint32 parent, real64 pos_x, real64 pos_y, real64 pos_z, real64 rot_x, real64 rot_y, real64 rot_z)
{
	...
	#if defined(V_PRINT_SEND_COMMANDS)
	printf("send: verse_send_g_bone_create(node_id = %u bone_id = %u name = %s parent = %u pos_x = %f pos_y = %f pos_z = %f rot_x = %f rot_y = %f rot_z = %f );\n", node_id, bone_id, name, parent, pos_x, pos_y, pos_z, rot_x, rot_y, rot_z);
	#endif
	buffer_pos += vnp_raw_pack_uint32(&buf[buffer_pos], node_id);
...
unsigned int v_unpack_g_bone_create(char *buf, unsigned int buffer_length, void *user_func, void *user_data)
{
	...
	#if defined(V_PRINT_RECIVE_COMMANDS)
	printf("receive: verse_send_g_bone_create(node_id = %u bone_id = %u name = %s parent = %u pos_x = %f pos_y = %f pos_z = %f rot_x = %f rot_y = %f rot_z = %f ); callback = %p\n", node_id, bone_id, name, parent, pos_x, pos_y, pos_z, rot_x, rot_y, rot_z, user_func);
	#endif
	if(name[0] == 0)
	{
